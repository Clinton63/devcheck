...
.sub{font-size:11px;color:#718096;margin-top:3px}
...
.rst{background:none;border:1px solid #E2E8F0;color:#718096;font-size:11px;cursor:pointer;font-family:'DM Sans',sans-serif;padding:4px 10px;border-radius:3px;transition:all .2s}
...
.pl{font-size:9px;color:#A0AEC0;letter-spacing:.07em;text-transform:uppercase;font-family:'JetBrains Mono',monospace;flex:1;text-align:center;transition:color .3s;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
...
.cdesc{font-size:13px;color:#718096;line-height:1.65;margin-bottom:24px;max-width:500px}
...
.fl input::placeholder,.fl textarea::placeholder{color:#A0AEC0}
.fl select option{background:#FFFFFF}
.fl textarea{resize:vertical;min-height:68px;line-height:1.5}
.fh{font-size:11px;color:#A0AEC0;line-height:1.5;margin-top:2px}
...
.sb{flex:1;padding:8px 9px;background:none;border:none;color:#718096;font-family:'DM Sans',sans-serif;font-size:12px;cursor:pointer;transition:all .2s;text-align:center}
...
.bs{background:transparent;color:#718096;border:1.5px solid #E2E8F0;border-radius:4px;padding:9px 18px;font-family:'DM Sans',sans-serif;font-size:12px;cursor:pointer;transition:all .2s}
...
.dd{font-size:12px;color:#718096;line-height:1.75}
...
.ai-think{padding:24px;display:flex;align-items:center;gap:10px;color:#718096;font-size:13px}
...
.md{font-size:12px;color:#718096;line-height:1.6}
...
.rl{font-size:9px;color:#718096;letter-spacing:.1em;text-transform:uppercase;font-family:'JetBrains Mono',monospace;margin-bottom:4px}
...
.tfnt{font-size:11px;color:#718096;line-height:1.55}
.div{display:flex;align-items:center;gap:9px;margin:14px 0}
.div span{font-size:9px;color:#A0AEC0;letter-spacing:.14em;text-transform:uppercase;font-family:'JetBrains Mono',monospace;white-space:nowrap}
.div::before,.div::after{content:'';flex:1;height:1px;background:#E2E8F0}
.info{background:#F0F4F8;border:1px solid #E2E8F0;border-radius:4px;padding:11px 14px;font-size:12px;color:#718096;line-height:1.6;margin-bottom:13px}
...
.cta-d{font-size:12px;color:#718096;line-height:1.75}
